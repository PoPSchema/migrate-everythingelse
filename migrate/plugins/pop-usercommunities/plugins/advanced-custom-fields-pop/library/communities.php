...
function gdUreAcfCommunitymembershipUpdateCustomformat($value, $post_id, $field)
{
    ...
    if ($key == GD_URE_METAKEY_PROFILE_COMMUNITIES_MEMBERSHIP) {
        ...
        \PoP\UserMeta\Utils::updateUserMeta($user_id, GD_URE_METAKEY_PROFILE_COMMUNITIES_MEMBERSTATUS, $customformat_status);
        \PoP\UserMeta\Utils::updateUserMeta($user_id, GD_URE_METAKEY_PROFILE_COMMUNITIES_MEMBERPRIVILEGES, $customformat_privileges);
        \PoP\UserMeta\Utils::updateUserMeta($user_id, GD_URE_METAKEY_PROFILE_COMMUNITIES_MEMBERTAGS, $customformat_tags);
    }
