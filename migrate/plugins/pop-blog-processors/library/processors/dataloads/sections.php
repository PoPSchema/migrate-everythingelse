...
class PoP_Blog_Module_Processor_CustomSectionDataloads extends PoP_Module_Processor_SectionDataloadsBase
{
    ...
    public function getRelevantRoute(array $module, array &$props): ?string
    {
        $routes = array(
            ...
            self::MODULE_DATALOAD_TAGS_MENTIONS => POP_TAXONOMIES_ROUTE_TAGS ,
            self::MODULE_DATALOAD_TAGS_SCROLL_DETAILS => POP_TAXONOMIES_ROUTE_TAGS ,
            self::MODULE_DATALOAD_TAGS_SCROLL_LIST => POP_TAXONOMIES_ROUTE_TAGS ,
